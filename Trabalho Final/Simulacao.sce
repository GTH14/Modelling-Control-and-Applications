...
// Condicoes iniciais
//x0 = 1/0.8650482*[0.8650482; -0.0069129; 0.0171400; 0.5013482] // Spiral mode
//x0 =  1/-0.8442836*[-0.8442836; -0.5045553; -0.001278; 0.1805757] // Roll mode
//x0 = real(1/0.9996717*[0.9996717; -0.0191409 - 0.0116472*%i; 0.0013758 + 0.0084968*%i; 0.0062522 - 0.0064214*%i]) Dutch Roll mode
x0 = [0;0;0;0]
// Cria o vetor de tempos
dt = 0.1; // Discretizacao do tempo
ti = 0; // Instante inicial
tf = 500; // Instante final
...
for i = 1:size(x)(1)
    ...
    xlabel("Tempo t(s)")
    xgrid()
//    xs2png(i, Name(i)+"_phi")
end
//title("Reposta para autovetor de Dutch Roll",'fontsize',4)
////ylabel()
//xlabel("Tempo t(s)")
//legend(["Ângulo de derrapagem [rad]", "Velocidade angular p [rad/s]", "Velocidade angular r [rad/s]",...
// "Ângulo de rolagem [rad]"])
//xs2png(1, "Dutch_Roll_mode")
